...
var rootCmd = &cobra.Command{
	...
	Long:  `eactl is a command-line interface (CLI) tool designed to interact with the easy-audit server. It provides various commands to manage and retrieve audit data from the server, allowing users to efficiently monitor and analyze their audit logs.`,
...
func Execute() {
	...
	fmt.Printf("Log Level: %s, Verbose: %t, Format: %s\n", cfg.LOG_Level, cfg.LOG_Verbose, cfg.LOG_Format)
